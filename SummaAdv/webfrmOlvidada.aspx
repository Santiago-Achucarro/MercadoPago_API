<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webfrmOlvidada.aspx.cs" Inherits="SummaWeb.webfrmOlvidada" %>
            ...
            <div class="main-login main-center">
                <form id="form1" runat="server" class="form-horizontal">
                    ...
                    <div id="divCambioClave">
                        ...
                        <div class="form-group">
                            <label for="TxtClaveCC" id="lClaveCC" class="cols-sm-2 control-label">Pin Enviado</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <%--<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>--%>
                                    <span class="input-group-addon"><span class="fa fa-key"></span></span>
                                    <asp:TextBox ID="txtPinEnviado" CssClass="form-control" runat="server" ForeColor="Black" Width="100%"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
