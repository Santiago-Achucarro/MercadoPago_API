                ...
                <div class="col-sm-8 col-md-8">
                    ...
                    <div class="row">        
                         <div class="col-sm-6 col-md-4" style="padding: 2px 3px;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-1" onclick="MostrarPagina('frmespvenMovimientosConStockKS', 'Punto de venta')">
                        ...
                        <div class="col-sm-3 col-md-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-2" onclick="MostrarPagina('frmstkExistenciasXDeposito', 'Consulta de stock')">
                    ...
                    <div class="row">        
                         <div class="col-sm-3 col-md-2" style="padding: 2px 3px;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-3" onclick="MostrarPagina('frmtesCobranzas', 'Cobranza')">
                                <i class="fas fa-file-invoice-dollar quasar-icono-btn-inicio"></i>
                                <span class="quasar-texto-btn-inicio">Cobranza</span>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-4" onclick="MostrarPagina('frmvenPedidos', 'Actualización de pedidos')">
                        ...
                        <div class="col-sm-3 col-md-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-5" onclick="MostrarPagina('frmvenPedidosDesechar', 'Desechar el pendiente de pedidos')">
                    ...
                    <div class="row">        
                         <div class="col-sm-3 col-md-2" style="padding: 2px 3px;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-6" onclick="MostrarPagina('frmtesDepositoCheques', 'Depósitos bancarios')">
                                <i class="fas fa-university quasar-icono-btn-inicio"></i>
                                <span class="quasar-texto-btn-inicio">Depósitos<br/>Bancarios</span>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-7" onclick="MostrarPagina('frmstkEntradasCD', 'Ingreso cambio de depósito')">
                        ...
                        <div class="col-sm-3 col-md-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-8" onclick="MostrarPagina('frmstkEnTransitoCD', 'Salidas cambio de depósito')">
                                <i class="fas fa-warehouse quasar-icono-btn-inicio"></i>
                    ...
                    <div class="row">        
                         <div class="col-sm-3 col-md-2" style="padding: 2px 3px;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-9" onclick="MostrarPagina('frmtesAperturaCaja', 'Apertura caja')">
                        ...
                        <div class="col-sm-2" style="padding: 2px 3px;;">
                            <div class="quasar-btn-inicio quasar-btn-inicio-10" onclick="MostrarPagina('rpttesRendicionCaja', 'Rendición de caja')">
                                <i class="fas fa-cash-register quasar-icono-btn-inicio"></i>
