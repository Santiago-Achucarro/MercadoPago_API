...
{
    public class proFechasMRP
    {

        [Generalidades.QFuncion_ObtenerParametrosReporte]
        public string AsignarParametros(ProduccionCommon.proProgramaFechasMrpDS Exch, Command cmd)
        {
            string lRetorno = "";
        ...
        public DataSet LlenarDataSet(string pParametros, Framework.Core.Command cmd)
        {
            ...
            ProduccionExchange.proProgramaFechasMrpActionExchange eExplo = new ProduccionExchange.proProgramaFechasMrpActionExchange(ProduccionExchange.proProgramaFechasMrpActionEnum.EnumproProgramaFechasMrpAction.Calcular)
            {
                ...
                IncluPendiente = Convert.ToBoolean(lPar[11].Split('|')[1])
            };

            eExplo = new ProduccionExchange.proProgramaFechasMrpActionExchange(Generalidades.QBIInternal.WrapperExecuteActionInternal(eExplo, cmd));
