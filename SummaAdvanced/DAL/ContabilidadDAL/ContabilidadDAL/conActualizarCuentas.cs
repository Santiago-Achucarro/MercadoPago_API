...
{
    public class conActualizarCuentas
    {
        ...
        public static conActualizarCuentasMovimientosDS Datos(string /*0*/pCuentaARemplazar, DateTime /*1*/pFechaDesde, DateTime /*2*/pFechaHasta, int /*3*/pEmpresa_Id, string /*4*/pCuentaRemplazo, string /*5*/ pAuxiliar)
        {
            ...
            DataSet ds = oiDAAB.getObject("conActualizarCuentasMovimientosDatos", parametros);

            string[] camposTabla0 = { "Cuenta_Remplazo", "DescripcionCuenta_Remplazo", "FechaDesde", "FechaHasta" };
            Generalidades.Auxiliares.ReemplazarNulos(ds.Tables[0], camposTabla0);

            string[] camposTabla1 = { "Segmento", "Centro1_Id", "DescripcionCentro1", "conCentro2", "DescripcionCentro2" };
        ...
        public static void Guardar(string /*0*/pCuentaARemplazar, string /*1*/pCuentaRemplazo, long /*2*/pconAsientos, int /*3*/pRenglon, string /*4*/ pAuxiliar)
        {
            Object[] parametros = new Object[] {/*0*/pCuentaARemplazar, /*1*/pCuentaRemplazo, /*2*/pconAsientos, /*3*/pRenglon };
