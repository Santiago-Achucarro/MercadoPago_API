...
{
    public class tesCheqPropEstado
    {
        public static tesCheqPropEstadoDS Datos(string /*0*/pEstado_Id, string /*1*/ pAuxiliar)
        {
            Object[] parametros = new Object[] {/*0*/pEstado_Id };

            iDAAB oiDAAB = Global.Global.globalDAAB(pAuxiliar);

            DataSet ds = oiDAAB.getObject("tesCheqPropEstadoDatos", parametros);

            tesCheqPropEstadoDS dsTipado = new tesCheqPropEstadoDS();
        ...
        public static void Eliminar(string /*0*/pEstado_Id, string /*1*/ pAuxiliar)
        {
            ...
            oiDAAB.eliminar("tesCheqPropEstadoEliminar", parametros);
        }
        ...
        public static void Guardar(string /*0*/pEstado_Id, string /*1*/pDescripcion, string /*2*/ pAuxiliar)
        {
            ...
            oiDAAB.guardar("tesCheqPropEstadoGuardar", parametros);
        }
