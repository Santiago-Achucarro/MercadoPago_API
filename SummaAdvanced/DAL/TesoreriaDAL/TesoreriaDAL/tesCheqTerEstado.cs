...
{
    public class tesCheqTerEstado
    {
        public static tesCheqTerEstadoDS Datos(string /*0*/pEstado_Id, string /*1*/ pAuxiliar)
        {
            Object[] parametros = new Object[] {/*0*/pEstado_Id };

            iDAAB oiDAAB = Global.Global.globalDAAB(pAuxiliar);

            DataSet ds = oiDAAB.getObject("tesCheqTerEstadoDatos", parametros);

            tesCheqTerEstadoDS dsTipado = new tesCheqTerEstadoDS();
        ...
        public static void Eliminar(string /*0*/pEstado_Id, string /*1*/ pAuxiliar)
        {
            ...
            oiDAAB.eliminar("tesCheqTerEstadoEliminar", parametros);
        }
        public static void Guardar(string /*0*/pEstado_Id, string /*1*/pDescripcion, string /*2*/ pAuxiliar)
        {
            ...
            oiDAAB.guardar("tesCheqTerEstadoGuardar", parametros);
        }
