...
{
    public class tesPagosImpuestos
    {

        public static TesoreriaCommon.tesMovimientosDatosBaseDS Datos(int /*0*/Empresa_Id, string /*1*/Segmento_Id, int /*2*/Segmento1N, int /*3*/Segmento2N, int /*4*/Segmento3N, int /*5*/Segmento4N, string /*6*/Segmento1C, string /*7*/Segmento2C, string /*8*/Segmento3C, string /*9*/Segmento4C, string /*10*/SegmentoIMP_Id, int /*11*/SegmentoIMP1N, int /*12*/SegmentoIMP2N, int /*13*/SegmentoIMP3N, int /*14*/SegmentoIMP4N, string /*15*/SegmentoIMP1C, string /*16*/SegmentoIMP2C, string /*17*/SegmentoIMP3C, string /*18*/SegmentoIMP4C, string /*19*/ pAuxiliar)
        {
            Object[] parametros = new Object[] {/*0*/Empresa_Id, /*1*/Segmento_Id, /*2*/Segmento1N, /*3*/Segmento2N, /*4*/Segmento3N, /*5*/Segmento4N, /*6*/Segmento1C, /*7*/Segmento2C, /*8*/Segmento3C, /*9*/Segmento4C, /*10*/SegmentoIMP_Id, /*11*/SegmentoIMP1N, /*12*/SegmentoIMP2N, /*13*/SegmentoIMP3N, /*14*/SegmentoIMP4N, /*15*/SegmentoIMP1C, /*16*/SegmentoIMP2C, /*17*/SegmentoIMP3C, /*18*/SegmentoIMP4C };

            iDAAB oiDAAB = Global.Global.globalDAAB(pAuxiliar);

            DataSet ds = oiDAAB.getObject("tesPagosImpDatos", parametros);
            ...
            string[] nombreTablas = { dsTipado.Principal.TableName, dsTipado.Debe.TableName, dsTipado.Haber.TableName,
                    dsTipado.ConciliacDebe.TableName, dsTipado.ConciliacHaber.TableName, dsTipado.TiposCambio.TableName,
                    dsTipado.genAtributosGenerales.TableName, dsTipado.SegmentoContrap.TableName};
