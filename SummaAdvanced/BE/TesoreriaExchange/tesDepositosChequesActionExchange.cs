...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesDepositosChequesActionExchange : Framework.Core.Exchange{
     ...
     public tesDepositosChequesActionExchange() : base( "tesDepositosCheques" ) {
     }

     public tesDepositosChequesActionExchange(tesDepositosChequesActionEnum.EnumtesDepositosChequesAction pAccion) : base(tesDepositosChequesActionEnum.GetAcciontesDepositosChequesAction(pAccion)) {
     }

     public tesDepositosChequesActionExchange(tesDepositosChequesActionEnum.EnumtesDepositosChequesAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesDepositosChequesActionEnum.GetAcciontesDepositosChequesAction(pAccion), pdsParam) {
     }

     public tesDepositosChequesActionExchange(Exchange pExch) : base() {
