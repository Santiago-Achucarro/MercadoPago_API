...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesMovimientosDatosBaseActionExchange : Framework.Core.Exchange{
     ...
     public tesMovimientosDatosBaseActionExchange() : base( "tesMovimientosDatosBase" ) {
     }

     public tesMovimientosDatosBaseActionExchange(tesMovimientosDatosBaseActionEnum.EnumtesMovimientosDatosBaseAction pAccion) : base(tesMovimientosDatosBaseActionEnum.GetAcciontesMovimientosDatosBaseAction(pAccion)) {
     }

     public tesMovimientosDatosBaseActionExchange(tesMovimientosDatosBaseActionEnum.EnumtesMovimientosDatosBaseAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesMovimientosDatosBaseActionEnum.GetAcciontesMovimientosDatosBaseAction(pAccion), pdsParam) {
     }

     public tesMovimientosDatosBaseActionExchange(Exchange pExch) : base() {
