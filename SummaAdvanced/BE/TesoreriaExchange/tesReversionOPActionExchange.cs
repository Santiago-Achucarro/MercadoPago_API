...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesReversionOPActionExchange : Framework.Core.Exchange{
     ...
     public tesReversionOPActionExchange() : base( "tesReversionOP" ) {
     }

     public tesReversionOPActionExchange(tesReversionOPActionEnum.EnumtesReversionOPAction pAccion) : base(tesReversionOPActionEnum.GetAcciontesReversionOPAction(pAccion)) {
     }

     public tesReversionOPActionExchange(tesReversionOPActionEnum.EnumtesReversionOPAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesReversionOPActionEnum.GetAcciontesReversionOPAction(pAccion), pdsParam) {
     }

     public tesReversionOPActionExchange(Exchange pExch) : base() {
