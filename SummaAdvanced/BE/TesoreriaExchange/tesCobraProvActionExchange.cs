...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesCobraProvActionExchange : Framework.Core.Exchange{
     ...
     public tesCobraProvActionExchange() : base( "tesCobraProv" ) {
     }

     public tesCobraProvActionExchange(tesCobraProvActionEnum.EnumtesCobraProvAction pAccion) : base(tesCobraProvActionEnum.GetAcciontesCobraProvAction(pAccion)) {
     }

     public tesCobraProvActionExchange(tesCobraProvActionEnum.EnumtesCobraProvAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesCobraProvActionEnum.GetAcciontesCobraProvAction(pAccion), pdsParam) {
     }

     public tesCobraProvActionExchange(Exchange pExch) : base() {
