...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesIngDepPorIdentActionExchange : Framework.Core.Exchange{
     ...
     public tesIngDepPorIdentActionExchange() : base( "tesIngDepPorIdent" ) {
     }

     public tesIngDepPorIdentActionExchange(tesIngDepPorIdentActionEnum.EnumtesIngDepPorIdentAction pAccion) : base(tesIngDepPorIdentActionEnum.GetAcciontesIngDepPorIdentAction(pAccion)) {
     }

     public tesIngDepPorIdentActionExchange(tesIngDepPorIdentActionEnum.EnumtesIngDepPorIdentAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesIngDepPorIdentActionEnum.GetAcciontesIngDepPorIdentAction(pAccion), pdsParam) {
     }

     public tesIngDepPorIdentActionExchange(Exchange pExch) : base() {
     ...
     public tesIngDepPorIdentActionExchange(TesoreriaCommon.tesMovimientosDatosBaseDS pDS) : base() {
     this.Action = "";
     this.mParam = new TesoreriaCommon.tesMovimientosDatosBaseDS();
