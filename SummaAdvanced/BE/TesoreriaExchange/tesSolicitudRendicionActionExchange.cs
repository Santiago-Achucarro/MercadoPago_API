...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesSolicitudRendicionActionExchange : Framework.Core.Exchange{
     ...
     public tesSolicitudRendicionActionExchange() : base( "tesSolicitudRendicion" ) {
     }

     public tesSolicitudRendicionActionExchange(tesSolicitudRendicionActionEnum.EnumtesSolicitudRendicionAction pAccion) : base(tesSolicitudRendicionActionEnum.GetAcciontesSolicitudRendicionAction(pAccion)) {
     }

     public tesSolicitudRendicionActionExchange(tesSolicitudRendicionActionEnum.EnumtesSolicitudRendicionAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesSolicitudRendicionActionEnum.GetAcciontesSolicitudRendicionAction(pAccion), pdsParam) {
     }

     public tesSolicitudRendicionActionExchange(Exchange pExch) : base() {
