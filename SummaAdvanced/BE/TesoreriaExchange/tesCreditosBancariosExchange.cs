...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesCreditosBancariosExchange : Framework.Core.Exchange{
     ...
     public tesCreditosBancariosExchange() : base( "tesCreditosBancarios" ) {
     }

     public tesCreditosBancariosExchange(tesCreditosBancariosEnum.EnumtesCreditosBancarios pAccion) : base(tesCreditosBancariosEnum.GetAcciontesCreditosBancarios(pAccion)) {
     }

     public tesCreditosBancariosExchange(tesCreditosBancariosEnum.EnumtesCreditosBancarios pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesCreditosBancariosEnum.GetAcciontesCreditosBancarios(pAccion), pdsParam) {
     }

     public tesCreditosBancariosExchange(Exchange pExch) : base() {
