...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesSaldosInicialesActionExchange : Framework.Core.Exchange{
     ...
     public tesSaldosInicialesActionExchange() : base( "tesSaldosIniciales" ) {
     }

     public tesSaldosInicialesActionExchange(tesSaldosInicialesActionEnum.EnumtesSaldosInicialesAction pAccion) : base(tesSaldosInicialesActionEnum.GetAcciontesSaldosInicialesAction(pAccion)) {
     }

     public tesSaldosInicialesActionExchange(tesSaldosInicialesActionEnum.EnumtesSaldosInicialesAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesSaldosInicialesActionEnum.GetAcciontesSaldosInicialesAction(pAccion), pdsParam) {
     }

     public tesSaldosInicialesActionExchange(Exchange pExch) : base() {
