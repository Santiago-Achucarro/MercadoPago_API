...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosClieDatosBaseActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosClieDatosBaseActionExchange() : base( "tesPagosClie" ) {
     }

     public tesPagosClieDatosBaseActionExchange(tesPagosClieDatosBaseActionEnum.EnumtesPagosClieDatosBaseAction pAccion) : base(tesPagosClieDatosBaseActionEnum.GetAcciontesPagosClieDatosBaseAction(pAccion)) {
     }

     public tesPagosClieDatosBaseActionExchange(tesPagosClieDatosBaseActionEnum.EnumtesPagosClieDatosBaseAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosClieDatosBaseActionEnum.GetAcciontesPagosClieDatosBaseAction(pAccion), pdsParam) {
     }

     public tesPagosClieDatosBaseActionExchange(Exchange pExch) : base() {
