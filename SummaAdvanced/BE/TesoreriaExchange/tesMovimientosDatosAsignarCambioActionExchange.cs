...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesMovimientosDatosAsignarCambioActionExchange : Framework.Core.Exchange{
     ...
     public tesMovimientosDatosAsignarCambioActionExchange() : base( "tesMovimientosDatosBase" ) {
     }

     public tesMovimientosDatosAsignarCambioActionExchange(tesMovimientosDatosBaseActionEnum.EnumtesMovimientosDatosBaseAction pAccion) : base(tesMovimientosDatosBaseActionEnum.GetAcciontesMovimientosDatosBaseAction(pAccion)) {
     }

     public tesMovimientosDatosAsignarCambioActionExchange(tesMovimientosDatosBaseActionEnum.EnumtesMovimientosDatosBaseAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesMovimientosDatosBaseActionEnum.GetAcciontesMovimientosDatosBaseAction(pAccion), pdsParam) {
     }

     public tesMovimientosDatosAsignarCambioActionExchange(Exchange pExch) : base() {
