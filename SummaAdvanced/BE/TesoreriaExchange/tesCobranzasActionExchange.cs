...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesCobranzasActionExchange : Framework.Core.Exchange{
        ...
        public Decimal TotalDebeOriginal {
            get {
                if(((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0]["TotalDebeOriginal"] != DBNull.Value  ){
                    return ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].TotalDebeOriginal;
                }
				else{
                    return 0;
                }
           ...
           set {
               InitParam();
	              ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].TotalDebeOriginal = value;
               }
	          }
        public bool IsTotalDebeOriginalNull {
             get {
                 return mParam==null || ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].IsTotalDebeOriginalNull();
             }
	        }
        public Decimal TotalHaberOriginal {
            get {
                if(((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0]["TotalHaberOriginal"] != DBNull.Value  ){
                    return ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].TotalHaberOriginal;
                }
				else{
                    return 0;
                }
           ...
           set {
               InitParam();
	              ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].TotalHaberOriginal = value;
               }
	          }
        public bool IsTotalHaberOriginalNull {
             get {
                 return mParam==null || ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].IsTotalHaberOriginalNull();
             }
	        }
        public String Sucursal {
            get {
                if(((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0]["Sucursal"] != DBNull.Value  ){
                    return ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].Sucursal;
                }
				else{
                    return "";
                }
           ...
           set {
               InitParam();
	              ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].Sucursal = value;
               }
	          }
        public bool IsSucursalNull {
             get {
                 return mParam==null || ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].IsSucursalNull();
             }
	        }
        public Decimal Diferencia {
            get {
                if(((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0]["Diferencia"] != DBNull.Value  ){
                    return ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].Diferencia;
                }
				else{
                    return 0;
                }
           ...
           set {
               InitParam();
	              ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].Diferencia = value;
               }
	          }
        public bool IsDiferenciaNull {
             get {
                 return mParam==null || ((TesoreriaCommon.tesMovimientosDatosBaseDS)mParam).Principal[0].IsDiferenciaNull();
             }
	        }
     ...
     public tesCobranzasActionExchange() : base( "tesCobranzas" ) {
     }

     public tesCobranzasActionExchange(tesCobranzasActionEnum.EnumtesCobranzasAction pAccion) : base(tesCobranzasActionEnum.GetAcciontesCobranzasAction(pAccion)) {
     }

     public tesCobranzasActionExchange(tesCobranzasActionEnum.EnumtesCobranzasAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesCobranzasActionEnum.GetAcciontesCobranzasAction(pAccion), pdsParam) {
     }

     public tesCobranzasActionExchange(Exchange pExch) : base() {
     ...
     public tesCobranzasActionExchange(TesoreriaCommon.tesMovimientosDatosBaseDS pDS) : base() {
     this.Action = "";
     this.mParam = new TesoreriaCommon.tesMovimientosDatosBaseDS();
