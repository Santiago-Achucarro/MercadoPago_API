...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesCreditosBancariosActionExchange : Framework.Core.Exchange{
     ...
     public tesCreditosBancariosActionExchange() : base( "tesCreditosBancarios" ) {
     }

     public tesCreditosBancariosActionExchange(tesCreditosBancariosActionEnum.EnumtesCreditosBancariosAction pAccion) : base(tesCreditosBancariosActionEnum.GetAcciontesCreditosBancariosAction(pAccion)) {
     }

     public tesCreditosBancariosActionExchange(tesCreditosBancariosActionEnum.EnumtesCreditosBancariosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesCreditosBancariosActionEnum.GetAcciontesCreditosBancariosAction(pAccion), pdsParam) {
     }

     public tesCreditosBancariosActionExchange(Exchange pExch) : base() {
