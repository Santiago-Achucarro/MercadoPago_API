...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosImpuestosActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosImpuestosActionExchange() : base( "tesPagosImpuestos" ) {
     }

     public tesPagosImpuestosActionExchange(tesPagosImpuestosActionEnum.EnumtesPagosImpuestosAction pAccion) : base(tesPagosImpuestosActionEnum.GetAcciontesPagosImpuestosAction(pAccion)) {
     }

     public tesPagosImpuestosActionExchange(tesPagosImpuestosActionEnum.EnumtesPagosImpuestosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosImpuestosActionEnum.GetAcciontesPagosImpuestosAction(pAccion), pdsParam) {
     }

     public tesPagosImpuestosActionExchange(Exchange pExch) : base() {
