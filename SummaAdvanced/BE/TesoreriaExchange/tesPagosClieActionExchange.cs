...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosClieActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosClieActionExchange() : base( "tesPagosClie" ) {
     }

     public tesPagosClieActionExchange(tesPagosClieActionEnum.EnumtesPagosClieAction pAccion) : base(tesPagosClieActionEnum.GetAcciontesPagosClieAction(pAccion)) {
     }

     public tesPagosClieActionExchange(tesPagosClieActionEnum.EnumtesPagosClieAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosClieActionEnum.GetAcciontesPagosClieAction(pAccion), pdsParam) {
     }

     public tesPagosClieActionExchange(Exchange pExch) : base() {
