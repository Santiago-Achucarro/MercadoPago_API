...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosProveedoresAsignarCambioActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosProveedoresAsignarCambioActionExchange() : base( "tesPagosProveedoresAsignarCambio" ) {
     }

     public tesPagosProveedoresAsignarCambioActionExchange(tesPagosProveedoresAsignarCambioActionEnum.EnumtesPagosProveedoresAsignarCambioAction pAccion) : base(tesPagosProveedoresAsignarCambioActionEnum.GetAcciontesPagosProveedoresAsignarCambioAction(pAccion)) {
     }

     public tesPagosProveedoresAsignarCambioActionExchange(tesPagosProveedoresAsignarCambioActionEnum.EnumtesPagosProveedoresAsignarCambioAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosProveedoresAsignarCambioActionEnum.GetAcciontesPagosProveedoresAsignarCambioAction(pAccion), pdsParam) {
     }

     public tesPagosProveedoresAsignarCambioActionExchange(Exchange pExch) : base() {
