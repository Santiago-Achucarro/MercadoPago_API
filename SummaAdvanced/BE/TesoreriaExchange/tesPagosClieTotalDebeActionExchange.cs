...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosClieTotalDebeActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosClieTotalDebeActionExchange() : base( "tesPagosClie" ) {
     }

     public tesPagosClieTotalDebeActionExchange(tesPagosClieTotalDebeActionEnum.EnumtesPagosClieTotalDebeAction pAccion) : base(tesPagosClieTotalDebeActionEnum.GetAcciontesPagosClieTotalDebeAction(pAccion)) {
     }

     public tesPagosClieTotalDebeActionExchange(tesPagosClieTotalDebeActionEnum.EnumtesPagosClieTotalDebeAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosClieTotalDebeActionEnum.GetAcciontesPagosClieTotalDebeAction(pAccion), pdsParam) {
     }

     public tesPagosClieTotalDebeActionExchange(Exchange pExch) : base() {
