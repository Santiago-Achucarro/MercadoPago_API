...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesDebitosBancariosActionExchange : Framework.Core.Exchange{
     ...
     public tesDebitosBancariosActionExchange() : base( "tesDebitosBancarios" ) {
     }

     public tesDebitosBancariosActionExchange(tesDebitosBancariosActionEnum.EnumtesDebitosBancariosAction pAccion) : base(tesDebitosBancariosActionEnum.GetAcciontesDebitosBancariosAction(pAccion)) {
     }

     public tesDebitosBancariosActionExchange(tesDebitosBancariosActionEnum.EnumtesDebitosBancariosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesDebitosBancariosActionEnum.GetAcciontesDebitosBancariosAction(pAccion), pdsParam) {
     }

     public tesDebitosBancariosActionExchange(Exchange pExch) : base() {
