...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesChequesRechCanjeActionExchange : Framework.Core.Exchange{
     ...
     public tesChequesRechCanjeActionExchange() : base( "tesChequesRechCanje" ) {
     }

     public tesChequesRechCanjeActionExchange(tesChequesRechCanjeActionEnum.EnumtesChequesRechCanjeAction pAccion) : base(tesChequesRechCanjeActionEnum.GetAcciontesChequesRechCanjeAction(pAccion)) {
     }

     public tesChequesRechCanjeActionExchange(tesChequesRechCanjeActionEnum.EnumtesChequesRechCanjeAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesChequesRechCanjeActionEnum.GetAcciontesChequesRechCanjeAction(pAccion), pdsParam) {
     }

     public tesChequesRechCanjeActionExchange(Exchange pExch) : base() {
