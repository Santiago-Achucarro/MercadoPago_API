...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesOtrosEgresosActionExchange : Framework.Core.Exchange{
     ...
     public tesOtrosEgresosActionExchange() : base( "tesOtrosEgresos" ) {
     }

     public tesOtrosEgresosActionExchange(tesOtrosEgresosActionEnum.EnumtesOtrosEgresosAction pAccion) : base(tesOtrosEgresosActionEnum.GetAcciontesOtrosEgresosAction(pAccion)) {
     }

     public tesOtrosEgresosActionExchange(tesOtrosEgresosActionEnum.EnumtesOtrosEgresosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesOtrosEgresosActionEnum.GetAcciontesOtrosEgresosAction(pAccion), pdsParam) {
     }

     public tesOtrosEgresosActionExchange(Exchange pExch) : base() {
