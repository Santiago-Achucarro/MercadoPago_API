...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesDepositoEfectivoActionExchange : Framework.Core.Exchange{
     ...
     public tesDepositoEfectivoActionExchange() : base( "tesDepositoEfectivo" ) {
     }

     public tesDepositoEfectivoActionExchange(tesDepositoEfectivoActionEnum.EnumtesDepositoEfectivoAction pAccion) : base(tesDepositoEfectivoActionEnum.GetAcciontesDepositoEfectivoAction(pAccion)) {
     }

     public tesDepositoEfectivoActionExchange(tesDepositoEfectivoActionEnum.EnumtesDepositoEfectivoAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesDepositoEfectivoActionEnum.GetAcciontesDepositoEfectivoAction(pAccion), pdsParam) {
     }

     public tesDepositoEfectivoActionExchange(Exchange pExch) : base() {
