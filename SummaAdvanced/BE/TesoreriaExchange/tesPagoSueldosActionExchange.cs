...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagoSueldosActionExchange : Framework.Core.Exchange{
     ...
     public tesPagoSueldosActionExchange() : base( "tesPagoSueldos" ) {
     }

     public tesPagoSueldosActionExchange(tesPagoSueldosActionEnum.EnumtesPagoSueldosAction pAccion) : base(tesPagoSueldosActionEnum.GetAcciontesPagoSueldosAction(pAccion)) {
     }

     public tesPagoSueldosActionExchange(tesPagoSueldosActionEnum.EnumtesPagoSueldosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagoSueldosActionEnum.GetAcciontesPagoSueldosAction(pAccion), pdsParam) {
     }

     public tesPagoSueldosActionExchange(Exchange pExch) : base() {
