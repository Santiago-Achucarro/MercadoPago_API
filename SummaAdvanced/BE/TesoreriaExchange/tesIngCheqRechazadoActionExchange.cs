...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesIngCheqRechazadoActionExchange : Framework.Core.Exchange{
     ...
     public tesIngCheqRechazadoActionExchange() : base( "tesIngCheqRechazado" ) {
     }

     public tesIngCheqRechazadoActionExchange(tesIngCheqRechazadoActionEnum.EnumtesIngCheqRechazadoAction pAccion) : base(tesIngCheqRechazadoActionEnum.GetAcciontesIngCheqRechazadoAction(pAccion)) {
     }

     public tesIngCheqRechazadoActionExchange(tesIngCheqRechazadoActionEnum.EnumtesIngCheqRechazadoAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesIngCheqRechazadoActionEnum.GetAcciontesIngCheqRechazadoAction(pAccion), pdsParam) {
     }

     public tesIngCheqRechazadoActionExchange(Exchange pExch) : base() {
