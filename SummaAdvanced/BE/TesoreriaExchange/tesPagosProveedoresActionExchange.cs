...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesPagosProveedoresActionExchange : Framework.Core.Exchange{
     ...
     public tesPagosProveedoresActionExchange() : base( "tesPagosProveedores" ) {
     }

     public tesPagosProveedoresActionExchange(tesPagosProveedoresActionEnum.EnumtesPagosProveedoresAction pAccion) : base(tesPagosProveedoresActionEnum.GetAcciontesPagosProveedoresAction(pAccion)) {
     }

     public tesPagosProveedoresActionExchange(tesPagosProveedoresActionEnum.EnumtesPagosProveedoresAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesPagosProveedoresActionEnum.GetAcciontesPagosProveedoresAction(pAccion), pdsParam) {
     }

     public tesPagosProveedoresActionExchange(Exchange pExch) : base() {
