...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesMovimientosActionExchange : Framework.Core.Exchange{
     ...
     public tesMovimientosActionExchange() : base( "tesMovimientos" ) {
     }

     public tesMovimientosActionExchange(tesMovimientosActionEnum.EnumtesMovimientosAction pAccion) : base(tesMovimientosActionEnum.GetAcciontesMovimientosAction(pAccion)) {
     }

     public tesMovimientosActionExchange(tesMovimientosActionEnum.EnumtesMovimientosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesMovimientosActionEnum.GetAcciontesMovimientosAction(pAccion), pdsParam) {
     }

     public tesMovimientosActionExchange(Exchange pExch) : base() {
