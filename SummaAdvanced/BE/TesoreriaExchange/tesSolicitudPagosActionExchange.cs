...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesSolicitudPagosActionExchange : Framework.Core.Exchange{
     ...
     public tesSolicitudPagosActionExchange() : base( "tesSolicitudPagos" ) {
     }

     public tesSolicitudPagosActionExchange(tesSolicitudPagosActionEnum.EnumtesSolicitudPagosAction pAccion) : base(tesSolicitudPagosActionEnum.GetAcciontesSolicitudPagosAction(pAccion)) {
     }

     public tesSolicitudPagosActionExchange(tesSolicitudPagosActionEnum.EnumtesSolicitudPagosAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesSolicitudPagosActionEnum.GetAcciontesSolicitudPagosAction(pAccion), pdsParam) {
     }

     public tesSolicitudPagosActionExchange(Exchange pExch) : base() {
