...
namespace TesoreriaExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class tesCheqPropDebitarCDActionExchange : Framework.Core.Exchange{
     ...
     public tesCheqPropDebitarCDActionExchange() : base( "tesCheqPropDebitarCD" ) {
     }

     public tesCheqPropDebitarCDActionExchange(tesCheqPropDebitarCDActionEnum.EnumtesCheqPropDebitarCDAction pAccion) : base(tesCheqPropDebitarCDActionEnum.GetAcciontesCheqPropDebitarCDAction(pAccion)) {
     }

     public tesCheqPropDebitarCDActionExchange(tesCheqPropDebitarCDActionEnum.EnumtesCheqPropDebitarCDAction pAccion, TesoreriaCommon.tesMovimientosDatosBaseDS pdsParam) : base(tesCheqPropDebitarCDActionEnum.GetAcciontesCheqPropDebitarCDAction(pAccion), pdsParam) {
     }

     public tesCheqPropDebitarCDActionExchange(Exchange pExch) : base() {
