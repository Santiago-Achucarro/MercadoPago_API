...
namespace ComprasExchange{
   // Generado por QBI
    ...
    /// </summary>
    public class comOrdenCompDatosConsActionExchange : Framework.Core.Exchange{
     ...
     public comOrdenCompDatosConsActionExchange() : base( "comOrdenCompDatosCons" ) {
     }

     public comOrdenCompDatosConsActionExchange(comOrdenCompDatosConsActionEnum.EnumcomOrdenCompDatosConsAction pAccion) : base(comOrdenCompDatosConsActionEnum.GetAccioncomOrdenCompDatosConsAction(pAccion)) {
     }

     public comOrdenCompDatosConsActionExchange(comOrdenCompDatosConsActionEnum.EnumcomOrdenCompDatosConsAction pAccion, ComprasCommon.comOrdenCompDatosConsDS pdsParam) : base(comOrdenCompDatosConsActionEnum.GetAccioncomOrdenCompDatosConsAction(pAccion), pdsParam) {
     }

     public comOrdenCompDatosConsActionExchange(Exchange pExch) : base() {
