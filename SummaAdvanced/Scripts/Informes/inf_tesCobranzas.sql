...
UNION ALL -- AGREGO LOS ANTICIPOS
SELECT 'Anticipo' as SegmentoSTR, conAsientos.Fecha as Fecha, 
	genMonedas.Moneda_Id, genMonedas.Descripcion as DescripcionMoneda, conAsientos.Cambio as Cambio, 
	--CASE WHEN conAsientos.Moneda_Id = conCuentas.Moneda_Id THEN conMovCont.ImporteMonedaOriginal ELSE conMovCont.Importe END Importe, 
	conMovCont.Importe, genMovCuotas.Saldo, Convert(Numeric(18,2),genMovCuotas.Saldo*conAsientos.Cambio) as SaldoOri, 
	conAsientos.conAsientos, conCuentas.Cuenta_Id, conMovCont.Importe AS MontoACobrar, --genMovCuotas.Importe as MontoACobrar, 
	tesRengMovi.Cambio CambioCobra, genMovCuotas.CuotaNro, genMovCuotas.FechaVencimiento
FROM tesRengMovi 
