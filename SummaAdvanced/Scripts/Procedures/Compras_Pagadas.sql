...
SELECT genPaises.Dominio_Id AS Pais, 
	...
	ISNULL((SELECT SUM(TotalPago) from comMovImpAcredita, comImpuestos, impTipoImpuesto  Where
	...
	vcomImpPagados.Tipo in( 'I7','T0', 'IF') ),0) as TotalPago, 
...
ISNULL((SELECT SUM(genCancMov.Importe) from genCancMov 
	Where
	genCancMov.Asiento_Id = vcomImpPagados.tesMovimientos and 
	genCancMov.Asiento_Id_Ap = vcomImpPagados.commovprov and
...
SELECT DISTINCT  genPaises.Dominio_Id AS Pais, 
	...
	commovprov.Importe as TotalPago,
