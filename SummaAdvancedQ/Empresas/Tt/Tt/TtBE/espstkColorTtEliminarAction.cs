...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase espstkColorTtEliminarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "espstkColorTtEliminarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase espstkColorTtEliminarAction. No olvide de dar de
/// alta la acción "espstkColorTtEliminarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class espstkColorTtEliminarAction:Framework.Core.IAction  
	 {
/// <summary>
