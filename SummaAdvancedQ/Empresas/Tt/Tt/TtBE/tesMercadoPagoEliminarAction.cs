...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase tesMercadoPagoEliminarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "tesMercadoPagoEliminarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase tesMercadoPagoEliminarAction. No olvide de dar de
/// alta la acción "tesMercadoPagoEliminarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class tesMercadoPagoEliminarAction:Framework.Core.IAction  
	 {
/// <summary>
...
public Exchange Execute( Command cmd, Exchange exch) 
{
   ...
   try
   {
                TtDAL.tesMercadoPago.Eliminar(req.MercadoPago_Id, cmd.ConnectionString);
