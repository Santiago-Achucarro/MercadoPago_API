...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase espstkColorTtDevolverDatosAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "espstkColorTtDevolverDatosAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase espstkColorTtDevolverDatosAction. No olvide de dar de
/// alta la acción "espstkColorTtDevolverDatosAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class espstkColorTtDevolverDatosAction:Framework.Core.IAction  
	 {
/// <summary>
