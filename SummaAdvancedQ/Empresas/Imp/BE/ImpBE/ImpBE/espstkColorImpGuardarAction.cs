...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase espstkColorImpGuardarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "espstkColorImpGuardarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase espstkColorImpGuardarAction. No olvide de dar de
/// alta la acción "espstkColorImpGuardarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class espstkColorImpGuardarAction:Framework.Core.IAction  
	 {
/// <summary>
