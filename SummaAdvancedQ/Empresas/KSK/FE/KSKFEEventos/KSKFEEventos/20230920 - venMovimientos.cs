...
namespace KSKFEEventos
{
    public class venMovimientos
    {
        ...
        public VentasCommon.venMovimientosConStockDS AsignarImportesCobranza(VentasCommon.venMovimientosConStockDS pCommonDS, Command cmd)
        {
            KSKCommon.espvenMovimientosConStockKSKDS ds = new KSKCommon.espvenMovimientosConStockKSKDS();
            ds.Merge(cmd.CommonDSEsp, false, System.Data.MissingSchemaAction.Ignore);

            ds.Principal[0].Total = pCommonDS.Principal[0].Importe;
            ds = CalcularImportes(ds);
        ...
        public VentasCommon.venMovimientosConStockDS AsignarImportes(VentasCommon.venMovimientosConStockDS exch, VentasCommon.venMovimientosConStockDS exchNoPost, int pIndice, Framework.Core.Command cmd)
        {
            ...
            ds.Identificadores[pIndice].Importe = ds.Principal[0].ImporteAAsignar;
            ds.Identificadores[pIndice].ImporteNeto = ds.Principal[0].ImporteAAsignar;
        ...
        public VentasCommon.venMovimientosConStockDS ElegirCuotas(venMovimientosConStockDS exch, venMovimientosConStockDS exchNoPost, int pIndice, Command cmd)
        {
            ...
            //TODO: Revisar si este nuevo campo sirve para calcular el total de lo que queda para asignar cuando hay tipos de pago varios y con intereses
            ds.Identificadores[pIndice].ImporteNeto = ds.Identificadores[pIndice].Importe;
            ...
            //TODO: Gustavo 16/09/2023 - Controlar (lo puse para que refresque los campos en la cobranza)
            CalcularImportes(ds);
        ...
        public VentasCommon.venMovimientosConStockDS CobrarPorMercadoPago(VentasCommon.venMovimientosConStockDS pCommonDS, Command cmd)
        {
            ...
            KSKCommon.espvenMovimientosConStockKSKDS ds = new KSKCommon.espvenMovimientosConStockKSKDS();
            ds.Merge(cmd.CommonDSEsp, false, System.Data.MissingSchemaAction.Ignore);
            ds.MercadoPago[0].IdMercadoPago = "ds5a54f4da15g4gdfsgfdsgersd2c45";
        ...
        public VentasCommon.venMovimientosConStockDS OrdenarMediosDePago(VentasCommon.venMovimientosConStockDS pCommonDS, Command cmd)
        {
            ...
            DataTable tablaOrdenada = ds.Identificadores.AsEnumerable()
                .OrderByDescending(r => r.Field<decimal>("Importe"))
                .CopyToDataTable();


            ds.Identificadores.Clear();
            foreach (DataRow item in tablaOrdenada.Rows)
            {
                ds.Identificadores.ImportRow(item);
            }
            ds.Identificadores.AcceptChanges();
        ...
        public VentasCommon.venMovimientosConStockDS Reiniciar(VentasCommon.venMovimientosConStockDS pCommonDS, Command cmd)
        {
            ...
            /// 4/8/2023 - se agrega el registro para que no transgreda en ....
            //pCommonDS.Cobranza.AddCobranzaRow(pCommonDS.Cobranza.Count,
            //                    "", "","",0, 0, "", "", "", "",
        ...
        private KSKCommon.espvenMovimientosConStockKSKDS CalcularImportes(KSKCommon.espvenMovimientosConStockKSKDS ds)
        {
            //TODO: para el resto tenes que tomar la venta neta y los valores de pagos netos FALTA
            

            ds.Principal[0].ImporteAsignado = ds.Identificadores.Sum(i => i.Importe); //pImporteAAsignar;
            ds.Principal[0].Resto = ds.Principal[0].Total - ds.Identificadores.Sum(i => i.ImporteNeto == 0 ? i.Importe : i.ImporteNeto);
