...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase esptesMPCobranzaKSKGenerarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "esptesMPCobranzaKSKGenerarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase esptesMPCobranzaKSKGenerarAction. No olvide de dar de
/// alta la acción "esptesMPCobranzaKSKGenerarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class esptesMPCobranzaKSKGenerarAction:Framework.Core.IAction  
	 {
/// <summary>
