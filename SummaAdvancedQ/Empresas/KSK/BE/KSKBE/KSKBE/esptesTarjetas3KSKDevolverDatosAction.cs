...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase esptesTarjetas3KSKDevolverDatosAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "esptesTarjetas3KSKDevolverDatosAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase esptesTarjetas3KSKDevolverDatosAction. No olvide de dar de
/// alta la acción "esptesTarjetas3KSKDevolverDatosAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class esptesTarjetas3KSKDevolverDatosAction:Framework.Core.IAction  
	 {
/// <summary>
