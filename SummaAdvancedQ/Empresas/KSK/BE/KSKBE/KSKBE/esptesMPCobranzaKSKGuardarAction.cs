...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase esptesMPCobranzaKSKGuardarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "esptesMPCobranzaKSKGuardarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase esptesMPCobranzaKSKGuardarAction. No olvide de dar de
/// alta la acción "esptesMPCobranzaKSKGuardarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class esptesMPCobranzaKSKGuardarAction:Framework.Core.IAction  
	 {
/// <summary>
