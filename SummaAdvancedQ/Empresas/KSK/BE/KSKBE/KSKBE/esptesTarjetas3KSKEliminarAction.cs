...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase esptesTarjetas3KSKEliminarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "esptesTarjetas3KSKEliminarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase esptesTarjetas3KSKEliminarAction. No olvide de dar de
/// alta la acción "esptesTarjetas3KSKEliminarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class esptesTarjetas3KSKEliminarAction:Framework.Core.IAction  
	 {
/// <summary>
