    ...
    public class espvenMovimientosConStockKSKMPEscanearOrdenAction : Framework.Core.IAction
    {
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                {
                    //se pago pero por alguna razon no devolvio el estado, intento de nuevo
                ...
                //// Pruebo en llenar el objeto de cobranzas sin guardarla
                //string lObs = "Cobranza Factura ";
