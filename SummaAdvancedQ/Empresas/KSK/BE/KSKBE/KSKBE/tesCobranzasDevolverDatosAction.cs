...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase tesCobranzasDevolverDatosAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "tesCobranzasDevolverDatosAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase tesCobranzasDevolverDatosAction. No olvide de dar de
    /// alta la acción "tesCobranzasDevolverDatosAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class tesCobranzasDevolverDatosAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                TesoreriaBE.tesCobranzasDevolverDatosAction action = new TesoreriaBE.tesCobranzasDevolverDatosAction();
