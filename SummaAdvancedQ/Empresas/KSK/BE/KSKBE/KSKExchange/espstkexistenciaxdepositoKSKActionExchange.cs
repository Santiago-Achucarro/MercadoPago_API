...
namespace KSKExchange{
   // Generado por QBI
    ...
    public class espstkexistenciaxdepositoKSKActionExchange : Framework.Core.Exchange{
        ...
        public String stkProductoEscaneo {
            get {
                if(((KSKCommon.espstkexistenciaxdepositoKSKDS)mParam).Principal[0]["stkProductoEscaneo"] != DBNull.Value  ){
                    return ((KSKCommon.espstkexistenciaxdepositoKSKDS)mParam).Principal[0].stkProductoEscaneo;
                }
				else{
                    return "";
                }
           ...
           set {
               InitParam();
	              ((KSKCommon.espstkexistenciaxdepositoKSKDS)mParam).Principal[0].stkProductoEscaneo = value;
               }
	          }
        public bool IsstkProductoEscaneoNull {
             get {
                 return mParam==null || ((KSKCommon.espstkexistenciaxdepositoKSKDS)mParam).Principal[0].IsstkProductoEscaneoNull();
             }
	        }
