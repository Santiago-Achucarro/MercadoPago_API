...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espvenComandasDatosKSKDevolverDatosAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espvenComandasDatosKSKDevolverDatosAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espvenComandasDatosKSKDevolverDatosAction. No olvide de dar de
    /// alta la acción "espvenComandasDatosKSKDevolverDatosAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espvenComandasDatosKSKDevolverDatosAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                KSKCommon.espvenComandasDatosKSKDS ds = KSKDAL.espvenComandasDatosKSK.Datos(req.Fecha, cmd.ConnectionString);
