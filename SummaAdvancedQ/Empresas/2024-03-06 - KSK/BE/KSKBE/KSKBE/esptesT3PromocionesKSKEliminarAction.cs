...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase esptesT3PromocionesKSKEliminarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "esptesT3PromocionesKSKEliminarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase esptesT3PromocionesKSKEliminarAction. No olvide de dar de
/// alta la acción "esptesT3PromocionesKSKEliminarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class esptesT3PromocionesKSKEliminarAction:Framework.Core.IAction  
	 {
/// <summary>
