...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase espvenMovimientosConStockKSKMPOrdenyEscaneoAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "espvenMovimientosConStockKSKMPOrdenyEscaneoAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase espvenMovimientosConStockKSKMPOrdenyEscaneoAction. No olvide de dar de
/// alta la acción "espvenMovimientosConStockKSKMPOrdenyEscaneoAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class espvenMovimientosConStockKSKMPOrdenyEscaneoAction:Framework.Core.IAction  
	 {
/// <summary>
