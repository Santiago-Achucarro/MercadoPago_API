...
{
/// <summary>
/// QBI:Utilizar esta sección para describir brevemente la clase espvenMovimientosConStockKSKCobrarAction
/// </summary>
/// <remarks>
/// Esta clase implementa la acción "espvenMovimientosConStockKSKCobrarAction"
///
/// Utilizar esta sección para documentar el funcionamiento 
/// de la clase espvenMovimientosConStockKSKCobrarAction. No olvide de dar de
/// alta la acción "espvenMovimientosConStockKSKCobrarAction" para que el Dispatcher
/// sepa como ejecutarla.
/// </remarks>
	 public class espvenMovimientosConStockKSKCobrarAction:Framework.Core.IAction  
	 {
/// <summary>
