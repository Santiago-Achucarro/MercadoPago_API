...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espstkTalleKSKEliminarAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espstkTalleKSKEliminarAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espstkTalleKSKEliminarAction. No olvide de dar de
    /// alta la acción "espstkTalleKSKEliminarAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espstkTalleKSKEliminarAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                KSKDal.espstkTalleKSK.Eliminar(req.Talle_Id, cmd.ConnectionString);
