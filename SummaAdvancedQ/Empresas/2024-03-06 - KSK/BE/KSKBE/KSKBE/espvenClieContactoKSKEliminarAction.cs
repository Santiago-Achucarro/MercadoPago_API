...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espvenClieContactoKSKEliminarAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espvenClieContactoKSKEliminarAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espvenClieContactoKSKEliminarAction. No olvide de dar de
    /// alta la acción "espvenClieContactoKSKEliminarAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espvenClieContactoKSKEliminarAction : Framework.Core.IAction
    {
        /// <summary>
