...
namespace KSKBE
{
    ...
    /// </remarks>
    public class espstkProductosKSKDevolverDatosAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                KSKCommon.espProductosColorTalleKSKDS ds = KSKDal.espProductosColorTalleKSK.Datos(req.Producto_Id, cmd.ConnectionString);
