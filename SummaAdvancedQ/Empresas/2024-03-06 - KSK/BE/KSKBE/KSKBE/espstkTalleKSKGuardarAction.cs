...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espstkTalleKSKGuardarAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espstkTalleKSKGuardarAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espstkTalleKSKGuardarAction. No olvide de dar de
    /// alta la acción "espstkTalleKSKGuardarAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espstkTalleKSKGuardarAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                KSKDal.espstkTalleKSK.Guardar(req.Talle_Id, req.Talle_Id_Nueva, req.PTodasEmpresas? 0: cmd.Empresa_Id, req.Descripcion, req.Inactivo, cmd.Usuario_Id, req.Posteado, cmd.ConnectionString);
