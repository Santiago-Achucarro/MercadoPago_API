...
namespace KSKDal
{
    public class espstkTalleKSK
    {
        public static espstkTalleKSKDS Datos(string /*0*/pTalle_Id, string /*1*/ pAuxiliar)
        {
            Object[] parametros = new Object[] {/*0*/pTalle_Id };

            iDAAB oiDAAB = Global.Global.globalDAAB(pAuxiliar);

            DataSet ds = oiDAAB.getObject("espstkTalleKSKDatos", parametros);
            ...
            espstkTalleKSKDS dsTipado = new espstkTalleKSKDS();
        ...
        public static void Guardar(string /*0*/pTalle_Id, string /*1*/pTalle_Id_Nuevo, int /*2*/pEmpresa_Id, string /*3*/pDescripcion, bool /*4*/pInactivo, int /*5*/pUsuario_Id, bool /*6*/pPosteado, string /*7*/ pAuxiliar)
        {
            ...
            oiDAAB.guardar("espstkTalleKSKGuardar", parametros);
        }
        ...
        public static void Eliminar(string /*0*/pTalle_Id, string /*1*/ pAuxiliar)
        {
            ...
            oiDAAB.eliminar("espstkTalleKSKEliminar", parametros);
        }
