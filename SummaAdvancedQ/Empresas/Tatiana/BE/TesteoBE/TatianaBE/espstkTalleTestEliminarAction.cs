...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espstkTalleTestEliminarAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espstkTalleTestEliminarAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espstkTalleTestEliminarAction. No olvide de dar de
    /// alta la acción "espstkTalleTestEliminarAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espstkTalleTestEliminarAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                TatianaDAL.espstkTalleTest.Eliminar(req.Talle_Id, cmd.ConnectionString);
