...
namespace TatianaBE
{
    ...
    public class espstkColorTestEliminarAction : Framework.Core.IAction
    {
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                TatianaExchange.espstkColorTestActionExchange exchColor = new espstkColorTestActionExchange(espstkColorTestActionEnum.EnumespstkColorTestAction.Datos);
                ...
                if (exchColor.Existe)
                {
                    TatianaDAL.espstkColorTest.Eliminar(req.Color_Id, cmd.ConnectionString);
                }
                else
                {
