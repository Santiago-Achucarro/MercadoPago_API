    ...
    public class espstkTalleTestGuardarAction : Framework.Core.IAction
    {
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                {
                    Generalidades.qFunctionalException.GenerarExcepcion("La descripcion no puedo ser vacia");
                }

                TatianaDAL.espstkTalleTest.Guardar(req.Talle_Id, req.Talle_Id_Nueva, cmd.Empresa_Id, req.Descripcion, req.Inactivo, cmd.Usuario_Id, req.Posteado, cmd.ConnectionString);
