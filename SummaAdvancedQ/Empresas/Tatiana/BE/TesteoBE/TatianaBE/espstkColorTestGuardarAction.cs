    ...
    public class espstkColorTestGuardarAction : Framework.Core.IAction
    {
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                ...
                TatianaDAL.espstkColorTest.Guardar(req.Color_Id, req.Color_Id_Nueva, cmd.Empresa_Id, req.Descripcion, req.Inactivo, cmd.Usuario_Id, req.Posteado, cmd.ConnectionString);
