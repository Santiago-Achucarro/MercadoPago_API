...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espProductosColorTalleTestGuardarAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espProductosColorTalleTestGuardarAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espProductosColorTalleTestGuardarAction. No olvide de dar de
    /// alta la acción "espProductosColorTalleTestGuardarAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espProductosColorTalleTestGuardarAction : Framework.Core.IAction
    {
        /// <summary>
