...
{
    /// <summary>
    /// QBI:Utilizar esta sección para describir brevemente la clase espMovConStkCodBarraLlenarGrillaAction
    /// </summary>
    /// <remarks>
    /// Esta clase implementa la acción "espMovConStkCodBarraLlenarGrillaAction"
    ///
    /// Utilizar esta sección para documentar el funcionamiento 
    /// de la clase espMovConStkCodBarraLlenarGrillaAction. No olvide de dar de
    /// alta la acción "espMovConStkCodBarraLlenarGrillaAction" para que el Dispatcher
    /// sepa como ejecutarla.
    /// </remarks>
    public class espMovConStkCodBarraLlenarGrillaAction : Framework.Core.IAction
    {
        /// <summary>
        ...
        public Exchange Execute(Command cmd, Exchange exch)
        {
            ...
            try
            {
                TestCommon.espMovConStkCodBarraDS ds = new TestCommon.espMovConStkCodBarraDS();
                ...
                req.Param.grdCuerpo.AddgrdCuerpoRow(0, 1, 0, ds.CodigoBarras[0].CodigoBarras, exchProd.CFVenta_Id, exchProd.Descripcion, exchSuc.DepositoVentas , exchSuc.DescripcionDepositoVentas, exchProd.Medida_Id, exchProd.DescripcionUniMed, 1, 1, 1, 0, 1, "", 0, "", exchPrec.PrecioLista, 0, exchPrec.PrecioLista, 0, 0, 0, 0, 0, 0, 0, 0, "", DateTime.Now.Date, 0, "", 0, 0, "", "", "", "", "");
