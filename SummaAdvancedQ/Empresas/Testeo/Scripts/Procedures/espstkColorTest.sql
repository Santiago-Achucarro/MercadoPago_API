DROP PROCEDURE espstkColorTestGuardar
GO
CREATE PROCEDURE espstkColorTestGuardar
(
...
DROP PROCEDURE espstkColorTestDatos
GO
CREATE PROCEDURE espstkColorTestDatos
(
@pColor_Id varchar(15)
)
AS
...
SELECT espstkColorTest.espstkColorTest, espstkColorTest.Color_Id, espstkColorTest.Color_Id Color_Id_Nueva, espstkColorTest.Empresa_Id,
...
WHERE (Color_Id = @pColor_Id)
  ...
  Declare @pidentity bigint= dbo.FuncFKespstkColorTest(@pColor_Id)
 Exec genAtributosGeneralesIdentityDatos @pidentity, 'espstkColorTest'
 RETURN @@Error 

GO

DROP PROCEDURE espstkColorTestEliminar
GO
CREATE PROCEDURE espstkColorTestEliminar
(
...
DROP FUNCTION FuncFKespstkColorTest
GO

CREATE FUNCTION FuncFKespstkColorTest
(
@pColor_Id varchar (15)
)
RETURNS int
